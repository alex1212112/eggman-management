<template>
  <div class="app-container">
    ...
    <el-dialog
      :title="dialogStatus === 'create' ? '添加SVIP' : '编辑SVIP'"
    ...
    >
      ...
      >
        <el-row style="margin-bottom: 20px">
          <el-col :span="12">
            <el-form-item label="SVIP名称" :label-width="formLabelWidth">
              <el-input v-model="svip.name" autocomplete="off" style="width: 195px;" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 20px">
          <el-col :span="12">
            <el-form-item label="等级" :label-width="formLabelWidth">
              <el-input-number v-model="svip.level" :precision="0" :step="1" :min="0" style="width: 195px;" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 20px">
          <el-col :span="12">
            <el-form-item label="最小月活跃次数" :label-width="formLabelWidth">
              <el-input-number v-model="svip.min_month_team_active" :precision="0" :step="1" :min="0" style="width: 195px;" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 20px">
          <el-col :span="12">
            <el-form-item label="最大月活跃次数" :label-width="formLabelWidth">
              <el-input-number v-model="svip.max_month_team_active" :precision="0" :step="1" :min="0" style="width: 195px;" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 20px">
          <el-col :span="12">
            <el-form-item label="分红比例(%)" :label-width="formLabelWidth">
              <el-input-number v-model="svip.ratio" :precision="3" :step="0.1" :min="0" style="width: 195px;" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    >
      <span class="text-center">
        此操作会直接删除SVIP，可能会产生数据关联错误，确定删除吗？
      </span>
      <div slot="footer" class="dialog-footer">
...
<script>
import { getList, postAdd, putEdit, delItem } from '@/api/svip'
...
export default {
  ...
  methods: {
    ...
    createData() {
      console.log(this.svip)
      postAdd(this.svip).then(res => {
        if (res.code === 200) {
          this.dialogFormVisible = false
          this.getList()
        }

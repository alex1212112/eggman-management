  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="抽奖类型" align="center">
        <template slot-scope="scope">
          <el-tag :type="scope.row.type === 1 ? '' : 'success'" effect="dark">{{ scope.row.type === 1 ? '普通抽奖' : '每周抽奖' }}</el-tag>
        </template>
      </el-table-column>
        ...
        <el-row style="margin-bottom: 20px">
          <el-col :span="24">
            <el-form-item label="抽奖类型" :label-width="formLabelWidth">
              <el-radio v-model="lucky.type" :label="1">普通抽奖</el-radio>
              <el-radio v-model="lucky.type" :label="2">每周抽奖</el-radio>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
